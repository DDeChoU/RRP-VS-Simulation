...
public:
	...
	void run(vector<Task> taskList, std::ostream &out, int schedule_mode, int simulation_time);
...
void Scheduler::run(vector<Task> taskList, std::ostream &out, int schedule_mode, int simulation_time)
{
